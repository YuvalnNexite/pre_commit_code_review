...
echo "2. Install Codex CLI (preferred): pip install codex-cli"
echo "3. Verify Codex CLI: codex chat --model gpt-5-codex-medium --input 'ping'"
echo "4. (Optional fallback) Install Gemini CLI: npm install -g @google/generative-ai-cli"
echo "5. (Optional fallback) Configure Gemini: gemini config set apiKey YOUR_API_KEY"
echo ""
